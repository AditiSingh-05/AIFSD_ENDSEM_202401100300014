...
function DashboardPage({ user, logout, view = "dashboard" }) {
...
export default function App() {
  ...
  return (
    <Routes>
      <Route path="/login" element={auth.token ? <Navigate to="/dashboard" replace /> : <AuthPage mode="login" saveSession={auth.saveSession} />} />
      <Route path="/signup" element={auth.token ? <Navigate to="/dashboard" replace /> : <AuthPage mode="signup" saveSession={auth.saveSession} />} />
      <Route
        path="/dashboard"
        element={
          <ProtectedRoute token={auth.token}>
            <DashboardPage logout={auth.logout} user={auth.user} view="dashboard" />
          </ProtectedRoute>
        }
      />
      <Route
        ...
        element={
          <ProtectedRoute token={auth.token}>
            <DashboardPage logout={auth.logout} user={auth.user} view="employees" />
          </ProtectedRoute>
        }
      />
      <Route
        ...
        element={
          <ProtectedRoute token={auth.token}>
            <DashboardPage logout={auth.logout} user={auth.user} view="performance" />
          </ProtectedRoute>
        }
      />
      <Route
        ...
        element={
          <ProtectedRoute token={auth.token}>
            <DashboardPage logout={auth.logout} user={auth.user} view="ai" />
          </ProtectedRoute>
        }
      />
      {["trainings", "reports", "departments", "skills", "users", "roles"].map((view) => (
        <Route
          element={
            <ProtectedRoute token={auth.token}>
              <DashboardPage logout={auth.logout} user={auth.user} view={view} />
            </ProtectedRoute>
          }
          key={view}
          path={`/${view}`}
